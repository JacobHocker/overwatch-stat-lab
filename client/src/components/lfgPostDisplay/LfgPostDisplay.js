        ...
        <div className='lfg-single-post-display-container'>
            ...
            <div className="post-display-body-container">
                ...
                <div className="post-group-size-display">
                    <h3>Looking for {groupSize} to play with!</h3>
                </div>
                {roles === 'N/A' ? 
                <div></div> :
            ...
            <div className="post-display-footer-container">
                <div className="likes-section">
                    <h3> {likes}<AiFillLike className="likes" /></h3>
                </div>
                <div className="comment-section">
                    <h3><BiCommentAdd className="comment-icon" /></h3>
                </div>
                <div className="edit-section">
                    <h3><AiFillEdit className='edit' /></h3>
                </div>
                <div className="delete-section">
                    <h3><FaTrash className="trash" /></h3>
                </div>
