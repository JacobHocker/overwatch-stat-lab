...
function PlayerQuickPlay({ currentStats }) {
    ...
    const awards = currentStats.careerStats.allHeroes.matchAwards
    const games = currentStats.careerStats.allHeroes.game
    const average = currentStats.careerStats.allHeroes.average
    const assists = currentStats.careerStats.allHeroes.assists
    const best = currentStats.careerStats.allHeroes.best
    const combat = currentStats.careerStats.allHeroes.combat
...
export default PlayerQuickPlay;